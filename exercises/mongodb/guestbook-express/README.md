...
Maak een nieuw project aan met de naam `guestbook-express` en installeer de `express` en `mongodb` package. Je kan deel van de code van de vorige [opgave](../guestbook/) hergebruiken.
...
![alt text](<../../../.gitbook/assets/guestbook (2).gif>)
