...
We starten van de database die we gemaakt hebben in de vorige [opgave](../pokemon-team/). We gaan nu een express applicatie maken die gebruik maakt van deze database.
...
![alt text](<../../../.gitbook/assets/pokemon-team (1).gif>)
