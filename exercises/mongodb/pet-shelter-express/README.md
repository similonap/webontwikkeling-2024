...
We starten van de database die we gemaakt hebben in de vorige [opgave](../pet-shelter/). We gaan nu een express applicatie maken die gebruik maakt van deze database.
...
![alt text](<../../../.gitbook/assets/pets (1).png>)
...
![alt text](<../../../.gitbook/assets/petssearch (1).png>)
